...
Channel.fromPath(params.v_germline_file, type: 'any').map{ file -> tuple(file.baseName, file) }.into{g_2_germlineFastaFile_g_8;g_2_germlineFastaFile_g_15;g_2_germlineFastaFile_g0_12;g_2_germlineFastaFile_g0_22}
Channel.fromPath(params.d_germline, type: 'any').map{ file -> tuple(file.baseName, file) }.into{g_3_germlineFastaFile_g_30;g_3_germlineFastaFile_g_34;g_3_germlineFastaFile_g14_0;g_3_germlineFastaFile_g14_1;g_3_germlineFastaFile_g0_12;g_3_germlineFastaFile_g0_16;g_3_germlineFastaFile_g21_12;g_3_germlineFastaFile_g21_16;g_3_germlineFastaFile_g11_12;g_3_germlineFastaFile_g11_16}
Channel.fromPath(params.j_germline, type: 'any').map{ file -> tuple(file.baseName, file) }.into{g_4_germlineFastaFile_g_31;g_4_germlineFastaFile_g14_0;g_4_germlineFastaFile_g14_1;g_4_germlineFastaFile_g0_12;g_4_germlineFastaFile_g0_17;g_4_germlineFastaFile_g21_12;g_4_germlineFastaFile_g21_17;g_4_germlineFastaFile_g11_12;g_4_germlineFastaFile_g11_17}


process Third_Alignment_D_MakeBlastDb {

input:
 set val(db_name), file(germlineFile) from g_3_germlineFastaFile_g21_16
...
input:
 set val(db_name), file(germlineFile) from g_4_germlineFastaFile_g21_17
...
output:
 ...
 set val(germ_name), file(germlineClone)  into g_15_germlineFastaFile1_g_40, g_15_germlineFastaFile1_g14_0, g_15_germlineFastaFile1_g14_1
...
output:
 set val(outname),file(outfile)  into g14_9_outputFileTSV0_g_31, g14_9_outputFileTSV0_g_30, g14_9_outputFileTSV0_g_40
...
input:
 set val(name),file(airrFile) from g14_9_outputFileTSV0_g_40
 set val(name1), file(germline_file) from g_15_germlineFastaFile1_g_40

output:
 set val("${call}_genotype"),file("${call}_genotype_report.tsv")  into g_40_outputFileTSV0_g_32
 set val("${call}_personal_reference"), file("${call}_personal_reference.fasta")  into g_40_germlineFastaFile1_g_34, g_40_germlineFastaFile1_g_37, g_40_germlineFastaFile1_g21_12, g_40_germlineFastaFile1_g21_22
...
input:
 set val(db_name), file(germlineFile) from g_40_germlineFastaFile1_g21_22
...
input:
 ...
 set val(name1), file(v_germline_file) from g_40_germlineFastaFile1_g21_12
 set val(name2), file(d_germline_file) from g_3_germlineFastaFile_g21_12
 set val(name3), file(j_germline_file) from g_4_germlineFastaFile_g21_12
...
input:
 ...
 set val(name2), file(v_germline_file) from g_40_germlineFastaFile1_g_37
...
g_40_germlineFastaFile1_g_34= g_40_germlineFastaFile1_g_34.ifEmpty([""]) 
...
input:
 ...
 set val(name1),file(v_germline) from g_40_germlineFastaFile1_g_34
...
input:
 ...
 set val(name3),file(v_genotype) from g_40_outputFileTSV0_g_32
